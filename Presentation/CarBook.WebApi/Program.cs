...
{
    options.RequireHttpsMetadata = false; // Https gereksin mi
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ValidAudience = JwtTokenDefaults.ValidAudience, // Dinleyici
        ValidIssuer = JwtTokenDefaults.ValidIssuer, // Yayýncý
        ClockSkew = TimeSpan.Zero, // Baþlangýç süresini sýfýrlama
        IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(JwtTokenDefaults.Key)),
        ValidateLifetime = true, // Token'ýn ayakta kalma süresi
...
#endregion
//Handler için kolaylýk "ServiceRegistiration sýnýfý"

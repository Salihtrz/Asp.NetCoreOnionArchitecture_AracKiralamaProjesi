    ...
    public class UpdateReviewValidator : AbstractValidator<UpdateReviewCommand>
    {
        public UpdateReviewValidator()
        {
            ...
            RuleFor(x => x.CustomerImage).NotEmpty().WithMessage("Lütfen müşteri görselini boş geçmeyiniz!")
                .MinimumLength(10).WithMessage("Lütfen en az 10 karakter uzunluğunda veri girişi yapınız!")
                .MaximumLength(200).WithMessage("Lütfen en fazla 200 karakter uzunluğunda veri girişi yapınız!");
        }
    }
}
